...
export const integrationCreators = {
  ...
  glances: GlancesIntegration,  uptimeKuma: UptimeKumaIntegration,} satisfies Record<IntegrationKind, IntegrationInstance | [(input: IntegrationInput) => Promise<Integration>]>;
